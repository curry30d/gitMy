	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$val->id}}</td>
				<td>{{$val->role_name}}</td>
				<td><a href="#">{{$val->auth_ids}}</a></td>
				<td>{{$val->auth_ac}}</td>
				<td class="f-14"><a title="分派" href="javascript:;" onclick="admin_role_assign('分派权限','../../admin/role/assign','{{$val->id}}')" style="text-decoration:none"><i class="Hui-iconfont">&#xe603;</i></a>
